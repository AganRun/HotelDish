<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.shxt.hotelDish.service.impl.HotelDishServiceImplSign" %>
...
<body marginwidth="0" marginheight="0">
	<div class="container" align="center">
		<div class="public-nav">您当前的位置：<a href="">菜单大全</a>><a href="">招牌大全</a></div>
		...
		<%
			HotelDishServiceImplSign hotelservice = new HotelDishServiceImplSign();
