			...
			<ul>
				<li class="ifame-item logo">
					<div class="item-warrp">
						<a href="#"><i>LOGO</i>
							<h3 class="logo-title">Marriott Hotel梦幻之旅</h3>
		...
		<div class="public-ifame-leftnav">
			...
			<ul class="left-nav-list">
				...
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							<li><a href="点餐管理/orderNotCook.jsp" target="content">点餐未做</a></li>
				...
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							<li><a href="菜品管理/dishes_add.jsp" target="content">增加菜品</a></li>
							<li><a href="菜品管理/dishes_manage.jsp" target="content">菜品操作</a></li>
						</ul>
					</div>
				</li>
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							<li><a href="员工管理/manage_add.jsp" target="content">增加员工</a></li>
							<li><a href="员工管理/manage_sel_staff.jsp" target="content">查看员工</a></li>
							<li><a href="员工管理/manage_query.jsp" target="content">查询员工</a></li>
						</ul>
					</div>
				</li>
				<li class="public-ifame-item">
